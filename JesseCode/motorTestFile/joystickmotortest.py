...
def set_rc_channels(master, ch1, ch2):
...
def main():
    ...
    print("Motor 1 (Left/Ch1): Press 'W' for Forward, 'S' for Reverse")
    print("Motor 2 (Right/Ch2): Press 'Up Arrow' for Forward, 'Down Arrow' for Reverse")
    ...
    try:
        ...
        while True:
            ...
            set_rc_channels(master, pwm1, pwm2)
        ...
        set_rc_channels(master, PWM_NEUTRAL, PWM_NEUTRAL)
        time.sleep(0.1)
